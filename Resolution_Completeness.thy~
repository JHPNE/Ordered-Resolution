...
proof(cases D\<^sub>G C\<^sub>G R\<^sub>G rule: ground.resolution.cases)
  ...
  proof(rule that)
    ...
    show resolution: "resolution (D, \<V>\<^sub>2) (C, \<V>\<^sub>1) (R', \<V>\<^sub>3)"
...
proof-
  ...
  obtain R' \<V>\<^sub>3 where
    ...
    inference_groundings: "\<iota>\<^sub>G \<in> inference_ground_instances (Infer [(D, \<V>\<^sub>2), (C, \<V>\<^sub>1)] (R', \<V>\<^sub>3))" and
  ...
  let ?\<iota> = "Infer [(D, \<V>\<^sub>2), (C, \<V>\<^sub>1)] (R', \<V>\<^sub>3)"
  show ?thesis
